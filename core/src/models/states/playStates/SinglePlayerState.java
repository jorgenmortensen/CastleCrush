...
public class SinglePlayerState extends models.states.State {

    Projectile projectile;
    models.entities.Cannon cannon;
    ...
    public SinglePlayerState(models.states.GameStateManager gsm) {
        super(gsm);
        angleUp = true;
        font = new BitmapFont();
        cannon = new models.entities.Cannon(new Vector3(width / 10, width / 10, 0), width / 10, width / 20,
